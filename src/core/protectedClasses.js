...
module.exports = {
  ...
  patterns: {
    ...
    race: {
      explicit: /\b(african\s+american|black\s+people|white\s+people|asian\s+people|hispanic|latino|latina|native\s+american|indigenous|caucasian|african|asian|european)\b/gi,
      implicit: /\b(urban\s+youth|inner\s+city|ghetto|hood)\b/gi
    },
    ethnicity: {
      explicit: /\b(jewish|muslim|christian|hindu|buddhist|sikh|arab|persian|turkish|chinese|japanese|korean|indian|mexican|british|french|german|italian|spanish)\b/gi
    },
    religion: {
      explicit: /\b(christian|muslim|jewish|hindu|buddhist|sikh|atheist|agnostic|religious|faith|belief|worship|prayer|church|mosque|temple|synagogue)\b/gi
    },
    nationality: {
      explicit: /\b(american|british|french|german|chinese|japanese|mexican|canadian|australian|immigrant|refugee|foreigner|alien|citizen)\b/gi,
    ...
    age: {
      explicit: /\b(elderly|senior|old\s+people|young\s+people|teenager|adolescent|millennial|gen\s+z|boomer|generation\s+x|youth|adult|child|kid)\b/gi,
      implicit: /\b(mature|immature|experienced|inexperienced)\b/gi
    },
    sexuality: {
      explicit: /\b(gay|lesbian|bisexual|homosexual|heterosexual|straight|lgbtq?\+|queer|asexual|pansexual|transgender|trans)\b/gi,
    ...
    political_identity: {
      explicit: /\b(republican|democrat|liberal|conservative|left-wing|right-wing|socialist|capitalist|fascist|communist|progressive|moderate)\b/gi
    },
    appearance: {
